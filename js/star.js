...
var sArray = new Object;
 sArray[0] = new Image;
 sArray[0].src = "../images/img36.png";
 for (var i=1; i<6; i++) {
  sArray[i] = new Image();
  sArray[i].src = "../images/img35.png";
}
 var starTimer;
 var pro ;
 var rate ;
 function initStar() {
  try {
   setProfix("star_");
   setStars(document.getElementById("yp").value,'yp');
   setProfix("taste_");
   setStars(document.getElementById("fw").value,'fw');
  
   setProfix("environment_");
   setStars(document.getElementById("fh").value,'fh');
  } catch(e){
  }
 }
